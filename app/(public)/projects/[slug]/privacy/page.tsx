...
export async function generateMetadata({ params }: ProjectLegalPageProps): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `${baseUrl}/projects/${project.slug}/privacy`,
    },
    openGraph: {
      title: `${project.title} Privacy Policy - MOSHRADIX`,
      description: `Privacy Policy for ${project.title}.`,
...
export default async function ProjectPrivacyPage({ params }: ProjectLegalPageProps) {
  const { slug } = await params
  const project = getProjectBySlug(slug)
  ...
  const sections = project.legalPrivacy ?? project.privacy
      ...
      <div className="mx-auto max-w-4xl">
        ...
        <header className="mb-12 space-y-5">
          ...
          <div className="space-y-4">
            ...
            <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">{project.title} Privacy Policy</h1>
