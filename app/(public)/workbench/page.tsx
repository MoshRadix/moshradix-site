...
export const metadata: Metadata = {
  title: "Workbench",
  description: "Active builds and works in progress. A peek into the digital workshop where ideas take shape.",
  keywords: ["experiments", "prototypes", "work in progress", "playground", "dev tools"],
  openGraph: {
    title: "Workbench — MOSHRADIX",
