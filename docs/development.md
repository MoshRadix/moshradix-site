...
\`\`\`bash
# Clone repository
git clone https://github.com/MoshRadix/moshradix.git
cd moshradix
...
export const metadata: Metadata = {
  title: 'About | MoshRadix',
  description: 'About Mohamed Shamil and this digital laboratory',
}
...
- **GitHub Issues**: https://github.com/MoshRadix/moshradix/issues
