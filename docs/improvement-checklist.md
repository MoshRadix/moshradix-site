...
export default function sitemap(): MetadataRoute.Sitemap {
  const posts = blogPosts.map((post) => ({
    url: `https://moshradix.dev/blog/${post.slug}`,
...
<rss version="2.0">
  <channel>
    <title>MoshRadix Blog</title>
    <link>https://moshradix.dev/blog</link>
    ...
    <item>
      ...
      <link>https://moshradix.dev/blog/${post.slug}</link>
