...
const socialLinks = [
  { label: "GitHub", href: "https://github.com/MoshRadix", icon: Github },
  { label: "Twitter", href: "https://twitter.com/MoshRadix", icon: Twitter },
  { label: "Blog", href: "http://www.mosh-one.us/", icon: Rss },
]
