...
const roles = ["tools for the isles", "offline-first apps", "home automations", "weekend hacks", "open source code"]
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-20 lg:items-center lg:min-h-[70vh]">
          ...
          <div className="space-y-8 sm:space-y-10">
            ...
            <p className="max-w-lg text-base sm:text-lg leading-relaxed text-muted-foreground animate-fade-in-up stagger-2">
              Welcome to my digital workshop — a space for experiments, prototypes, and open-source tools. Currently
              building <span className="text-foreground font-medium">MTO Samugaa</span>, an offline-first
              productivity suite for local government staff. Here, ideas are forged, tested, and refined. Not a
              portfolio. A laboratory.
            </p>
