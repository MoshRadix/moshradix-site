import { Github, Twitter, Rss, ExternalLink, Heart } from "lucide-react"

const socialLinks = [
  { label: "GitHub", href: "https://github.com/MoshRadix", handle: "@MoshRadix", icon: Github },
  { label: "Twitter", href: "https://twitter.com/MoshRadix", handle: "@MoshRadix", icon: Twitter },
  { label: "Blog", href: "http://www.mosh-one.us/", handle: "Codexero", icon: Rss },
]
      ...
      <div className="mx-auto max-w-7xl">
        <div className="grid gap-12 sm:gap-16 lg:grid-cols-2">
          ...
          <div className="space-y-6 sm:space-y-8 animate-fade-in-up">
            ...
            <p className="max-w-md text-base sm:text-lg text-muted-foreground leading-relaxed">
              Always happy to swap notes on open source, home automation, or offline-first software — or hear about
              what you're tinkering with from your corner of the world.
            </p>

            <div className="pt-2">
              <a
                href="https://github.com/MoshRadix"
                target="_blank"
              ...
              >
                <span className="relative z-10">say hello on github</span>
        ...
        <div className="mt-16 sm:mt-20 flex flex-col items-center justify-between gap-6 border-t border-border/30 pt-8 sm:pt-10 sm:flex-row animate-fade-in stagger-4">
          ...
          <p className="font-mono text-xs text-muted-foreground text-center sm:text-right">
            © {new Date().getFullYear()} MOSHRADIX — All artifacts reserved
          </p>
        </div>
      </div>
    </footer>
