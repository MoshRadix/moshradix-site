...
const notes = [
  {
    ...
    excerpt: "How template placeholders get auto-computed and weekday or date logic gets handled when generating Word and Excel documents entirely offline.",
    date: "Jun 2026",
    category: "systems",
  ...
  },
  {
    ...
    excerpt: "A look at building a Dart client for TikTok LIVE's realtime comment and gift stream, and what it takes to keep a long-lived connection alive.",
    date: "Feb 2024",
    category: "frontend",
  ...
  },
  {
    ...
    excerpt: "Getting an offline voice assistant talking to Home Assistant on amd64 hardware, so commands never have to leave the house.",
    date: "Oct 2019",
    category: "automation",
