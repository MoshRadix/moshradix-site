...
const categories = [
  ...
  { name: "Software", count: 3, slug: "software" },
  { name: "Hardware", count: 2, slug: "hardware" },
  { name: "Security", count: 1, slug: "security" },
]

const popularTags = ["windows", "dhivehi", "security", "networking", "linux", "dd-wrt", "privacy", "bot", "fonts", "wifi"]
